...
int main() {    
    ...
    auto ss = ros::ServiceServer<Parameter::Request, Parameter::Response>("__set_parameter__", set_parameters);
    rosserial::nh.advertiseService(ss);
...
std::size_t length(const float array[]) {
